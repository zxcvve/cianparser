...
class CianParser:
    def __init__(self, location: str, proxies=None, output_format="csv"):
        """
        ...
        :param output_format: format for saving results ("csv" or "json"), default "csv"
        """
        ...
        self.__output_format__ = output_format.lower()
    ...
    def get_flats(
        ...
        self.__parser__ = FlatListPageParser(
            ...
            output_format=self.__output_format__,
    ...
    if type(rooms) is tuple:
        for count_of_room in rooms:
            if type(count_of_room) is int:
                ...
                raise ValueError(
                    f'In tuple "rooms" not valid type of element. '
        ...
        raise ValueError(
            f'In argument "rooms" not valid type of element. '
